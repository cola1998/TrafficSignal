...
if __name__ == "__main__":
    ...
    sumofile = '../DQN/unbalance_net/low_net.sumocfg'
    ...
    for episode in range(Max_episodes):
        ...
        while traci.simulation.getMinExpectedNumber() > 0 and step < Max_steps:  #
            ...
            action = agent.select_action(current_state,epsilon0=round(episode / Max_episodes, 2))  # epsilon0=round(episode / Max_episodes, 2)
    ...
    record_data(per_reward_list, per_waiting_time_list, per_delay_time_list, per_queue_list, loss_list,
                remain_car_numbers, fname)
    fname2 = 'data_save/new/ft_data_{0}.xlsx'.format(N)
    record_data_ft(ft_waiting_time_list,ft_delay_time_list,ft_queue_list,ft_remain_car_numbers,fname2)
